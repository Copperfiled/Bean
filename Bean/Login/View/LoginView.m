...
//        CGFloat height = frame.size.height;
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            ltV.tag = 1000 + i;
            if (i == 1) {
                ltV.textField.secureTextEntry = YES;
            }
            [self addSubview:ltV];
            [ltV release];
        }
        ...
        _loginButton.frame = CGRectMake(LEFTPADDING + 20, TOPPADDING + 2 * LTVHEIGHT + 2 * VERTICALPADDING, 100, 50);
        ...
        _registButton.frame = CGRectMake(180, TOPPADDING + 2 * LTVHEIGHT + 2 * VERTICALPADDING, 100, 50);
